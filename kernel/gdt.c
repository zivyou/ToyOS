...
typedef struct gdt_entry{
    ...
    uint8_t  dpl:2;    //descriptor privilege level     // 45-46
    uint8_t    p:1;        //segment present            // 47-47
    // -- granularity begin
...
void set_gdt_entry_for_tss(int32_t index, uint32_t base, uint32_t limit, uint8_t access, uint8_t gran) {
...
void set_tss_entry(int index, uint16_t ss0, uint32_t esp0) {
